...
public class Const_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 각각 Array, Linked, Vector 클래스를 사용하여 생성하였다
		 * 
		 * strList1, strList2, strList3은
		 * 각각 Array, Linked, Vector 타입으로
		 * 데이터형이 다르다
		 * 
		 *  하지만 List Interface 타입으로 선언되었기 때문에
		 *  메서드 등의 연산을 공용으로 사용할 수 있다
	...
	/*
	 * 매개변수 타입을 List Interface 타입으로 선언한 메서드
	 * 
	 * 이 메서드는 List Interface의 자손인
	 * ArrayList, LinkedList, Vector 클래스로 생성된 객체를
	 * 매개변수로 받아 연산을 수행할 수 있다
	 * 
	 * 즉, 한개의 메서드로 다수 타입의 값들을
	 * 연산수행할 수 있다
	 */
